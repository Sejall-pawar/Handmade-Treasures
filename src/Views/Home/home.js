  ...
  return (
    <div>
      <Header />
       ...
       <h1 className='tagline'>{MAIN_TITLE}</h1>
       <p className='tag-para'>Discover a world of unique, handcrafted items made with love and care. At Handmade Treasures, 
        ...
        <h1 className='explore-tag'>Explore Our Collections</h1>
       ...
       <div className='product-container'>
            ...
            <h1 className='product-name'>Home Decor</h1> 
       ...
       <div className='product-container'>
            ...
            <h1 className='product-name'>Apparel</h1> 
       ...
       <div className='product-container'>
            ...
            <h1 className='product-name'>Gifts</h1> 
